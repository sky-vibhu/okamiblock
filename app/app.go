...
import (
	...
	_ "github.com/okamiblock/okamiblock/client/docs/statik"

	"github.com/okamiblock/okamiblock/app/ante"
	"github.com/okamiblock/okamiblock/encoding"
	"github.com/okamiblock/okamiblock/ethereum/eip712"
	"github.com/okamiblock/okamiblock/precompiles/common"
	srvflags "github.com/okamiblock/okamiblock/server/flags"
	okamitypes "github.com/okamiblock/okamiblock/types"
	"github.com/okamiblock/okamiblock/x/epochs"
	epochskeeper "github.com/okamiblock/okamiblock/x/epochs/keeper"
	epochstypes "github.com/okamiblock/okamiblock/x/epochs/types"
	"github.com/okamiblock/okamiblock/x/erc20"
	erc20client "github.com/okamiblock/okamiblock/x/erc20/client"
	erc20keeper "github.com/okamiblock/okamiblock/x/erc20/keeper"
	erc20types "github.com/okamiblock/okamiblock/x/erc20/types"
	"github.com/okamiblock/okamiblock/x/evm"
	evmkeeper "github.com/okamiblock/okamiblock/x/evm/keeper"
	evmtypes "github.com/okamiblock/okamiblock/x/evm/types"
	"github.com/okamiblock/okamiblock/x/feemarket"
	feemarketkeeper "github.com/okamiblock/okamiblock/x/feemarket/keeper"
	feemarkettypes "github.com/okamiblock/okamiblock/x/feemarket/types"
	"github.com/okamiblock/okamiblock/x/incentives"
	inflation "github.com/okamiblock/okamiblock/x/inflation/v1"
	inflationkeeper "github.com/okamiblock/okamiblock/x/inflation/v1/keeper"
	inflationtypes "github.com/okamiblock/okamiblock/x/inflation/v1/types"
	revenue "github.com/okamiblock/okamiblock/x/revenue/v1"
	revenuekeeper "github.com/okamiblock/okamiblock/x/revenue/v1/keeper"
	revenuetypes "github.com/okamiblock/okamiblock/x/revenue/v1/types"
	"github.com/okamiblock/okamiblock/x/vesting"
	vestingclient "github.com/okamiblock/okamiblock/x/vesting/client"
	vestingkeeper "github.com/okamiblock/okamiblock/x/vesting/keeper"
	vestingtypes "github.com/okamiblock/okamiblock/x/vesting/types"

	// NOTE: override ICS20 keeper to support IBC transfers of ERC20 tokens
	"github.com/okamiblock/okamiblock/x/ibc/transfer"
	transferkeeper "github.com/okamiblock/okamiblock/x/ibc/transfer/keeper"
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".okamid")

	// manually update the power reduction by replacing micro (u) -> atto (a) okami
	sdk.DefaultPowerReduction = okamitypes.PowerReduction
...
var (
	_ servertypes.Application = (*Okami)(nil)
	_ ibctesting.TestingApp   = (*Okami)(nil)
	_ runtime.AppI            = (*Okami)(nil)
)

// Okami implements an extended ABCI application. It is an application
...
func (*Okami) SimulationManager() *module.SimulationManager {
	panic("unimplemented")
}

// NewOkami returns a reference to a new initialized Ethermint application.
func NewOkami(
	logger log.Logger,
	db dbm.DB,
	...
	app.AccountKeeper = authkeeper.NewAccountKeeper(
		...
		okamitypes.ProtoAccount, maccPerms,
...
func (app *Okami) Name() string { return app.BaseApp.Name() }

func (app *Okami) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
	options := ante.HandlerOptions{
		Cdc:                    app.appCodec,
		AccountKeeper:          app.AccountKeeper,
		BankKeeper:             app.BankKeeper,
		ExtensionOptionChecker: okamitypes.HasDynamicFeeExtensionOption,
...
func (app *Okami) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
...
func (app *Okami) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// The DeliverTx method is intentionally decomposed to calculate the transactions per second.
func (app *Okami) DeliverTx(req abci.RequestDeliverTx) (res abci.ResponseDeliverTx) {
	defer func() {
...
func (app *Okami) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *Okami) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *Okami) ModuleAccountAddrs() map[string]bool {
...
func (app *Okami) BlockedAddrs() map[string]bool {
...
// LegacyAmino returns Okami's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Okami) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}

// AppCodec returns Okami's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Okami) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns Okami's InterfaceRegistry
func (app *Okami) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *Okami) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Okami) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *Okami) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Okami) GetSubspace(moduleName string) paramstypes.Subspace {
...
// API server.
func (app *Okami) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *Okami) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *Okami) RegisterTendermintService(clientCtx client.Context) {
...
func (app *Okami) RegisterNodeService(clientCtx client.Context) {
...
func (app *Okami) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeper implements the TestingApp interface.
func (app *Okami) GetStakingKeeper() ibctestingtypes.StakingKeeper {
	return app.StakingKeeper
}

// GetStakingKeeperSDK implements the TestingApp interface.
func (app *Okami) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *Okami) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

// GetScopedIBCKeeper implements the TestingApp interface.
func (app *Okami) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.ScopedIBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *Okami) GetTxConfig() client.TxConfig {
...
// func (app *Okami) setupUpgradeHandlers() {
// 	// v8 upgrade handler
