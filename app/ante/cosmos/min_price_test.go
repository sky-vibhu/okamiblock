...
func (suite *AnteTestSuite) TestMinGasPriceDecorator() {
	...
	testMsg := banktypes.MsgSend{
		FromAddress: "okami1x8fhpj9nmhqk8z9kpgjt95ck2xwyue0ptzkucp",
		ToAddress:   "okami1dx67l23hz9l0k9hcher8xz04uj7wf3yu26l2yn",
	...
	testCases := []struct {
		...
		},
		{
			...
			func() sdk.Tx {
				...
				txBuilder := suite.CreateTestCosmosTxBuilder(math.NewInt(10), "okami", &testMsg)
