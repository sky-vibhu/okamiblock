...
func init() {
	cfg := sdk.GetConfig()
	cfg.SetBech32PrefixForAccount("okami", "okamipub")
}
...
func TestGetTransferSenderRecipient(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
						Sender:   "cosmos1",
						Receiver: "okami1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
						Amount:   "123456",
					},
				),
			},
		...
		{
			"valid - cosmos sender, okami recipient",
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
						Sender:   "cosmos1qql8ag4cluz6r4dz28p3w00dnc9w8ueulg2gmc",
			...
			"okami1qql8ag4cluz6r4dz28p3w00dnc9w8ueuafmxps",
			"okami1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
			false,
		},
		{
			"valid - okami sender, cosmos recipient",
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
						Sender:   "okami1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
		...
		{
			"valid - osmosis sender, okami recipient",
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
...
func TestGetReceivedCoin(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			"transfer",
			"channel-0",
			"transfer/channel-0/aOKM",
			"10",
			sdk.Coin{Denom: "aOKM", Amount: math.NewInt(10)},
		},
		{
...
func TestGetSentCoin(t *testing.T) {
	testCases := []struct {
		...
		{
			"get unwrapped aOKM coin",
			"aOKM",
			"10",
			sdk.Coin{Denom: "aOKM", Amount: math.NewInt(10)},
		},
		{
			"get ibc wrapped aOKM coin",
			"transfer/channel-0/aOKM",
			"10",
			sdk.Coin{Denom: teststypes.AokamiIbcdenom, Amount: math.NewInt(10)},
		},
		{
