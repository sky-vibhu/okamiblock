...
import (
	...
	cryptocodec "github.com/okamiblock/okamiblock/crypto/codec"
	enccodec "github.com/okamiblock/okamiblock/encoding/codec"
...
func TestKeyring(t *testing.T) {
	...
	kr, err := keyring.New("okami", keyring.BackendTest, dir, mockIn, TestCodec, EthSecp256k1Option())
	...
	info, mnemonic, err := kr.NewMnemonic("foo", keyring.English, okamitypes.BIP44HDPath, keyring.DefaultBIP39Passphrase, EthSecp256k1)
	require.NoError(t, err)
...
func TestDerivation(t *testing.T) {
	bz, err := EthSecp256k1.Derive()(mnemonic, keyring.DefaultBIP39Passphrase, okamitypes.BIP44HDPath)
	require.NoError(t, err)
	require.NotEmpty(t, bz)
	...
	path := MustParseDerivationPath(okamitypes.BIP44HDPath)
	account, err := wallet.Derive(path, false)
	require.NoError(t, err)
	...
	// Equality of Okami implementation
	...
	// Equality of Eth and Okami implementation
	...
	// Inequality of wrong derivation path of Eth and Okami implementation
