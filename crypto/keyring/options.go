...
import (
	...
	"github.com/okamiblock/okamiblock/wallets/ledger"
)

// AppName defines the Ledger app used for signing. Okami uses the Ethereum app
const AppName = "Ethereum"

var (
	// SupportedAlgorithms defines the list of signing algorithms used on Okami:
	//  - eth_secp256k1 (Ethereum)
	SupportedAlgorithms = keyring.SigningAlgoList{hd.EthSecp256k1}
	// SupportedAlgorithmsLedger defines the list of signing algorithms used on Okami for the Ledger device:
	...
	// LedgerDerivation defines the Okami Ledger Go derivation (Ethereum app with EIP-712 signing)
	LedgerDerivation = ledger.OkamiLedgerDerivation()
