...
Please refer to the official Okami [bug bounty program](https://immunefi.com/bounty/okami/)
...
- Use the Okami [bug bounty program](https://immunefi.com/bounty/okami/) on Immunefi to disclose all vulnerabilities,
...
Okami uses the following disclosure process:
...
2. The team determines the vulnerability’s potential impact on Okami.
...
- For `High` and `Critical`:
    1. Patches are prepared for supported releases of Okami in a
    ...
    4. The nodes and validators update their Okami and Ethermint dependencies to use these releases.
    5. A week (or less) after the security vulnerability has been patched on Okami,
...
including but not limited to Okami,
as secure as possible.

### Payment Process

The payment process will be executed according to Okami’s Immunefi Bug Bounty program Rules.

### Contact

The Okami Security Team is constantly being monitored.
If you need to reach out to the team directly,
please reach out via email: [security@okami.org](mailto:security@okami.org)
