...
import (
	...
	"github.com/okamiblock/okamiblock/wallets/accounts"
	"github.com/okamiblock/okamiblock/wallets/usbwallet"
)
...
func OkamiLedgerDerivation() Secp256k1DerivationFn {
	okamiSECP256K1 := new(OkamiSECP256K1)

	return func() (sdkledger.SECP256K1, error) {
		return okamiSECP256K1.connectToLedgerApp()
	}
}

var _ sdkledger.SECP256K1 = &OkamiSECP256K1{}

// OkamiSECP256K1 defines a wrapper of the Ethereum App to
// for compatibility with Cosmos SDK chains.
type OkamiSECP256K1 struct {
	*usbwallet.Hub
...
func (e OkamiSECP256K1) Close() error {
...
func (e OkamiSECP256K1) GetPublicKeySECP256K1(hdPath []uint32) ([]byte, error) {
	if e.PrimaryWallet == nil {
...
// GetAddressPubKeySECP256K1 takes in the HD path as well as a "Human Readable Prefix" (HRP, e.g. "okami")
// to return the public key bytes in secp256k1 format as well as the account address.
func (e OkamiSECP256K1) GetAddressPubKeySECP256K1(hdPath []uint32, hrp string) ([]byte, string, error) {
	if e.PrimaryWallet == nil {
...
func (e OkamiSECP256K1) SignSECP256K1(hdPath []uint32, signDocBytes []byte) ([]byte, error) {
...
func (e OkamiSECP256K1) displayEIP712Hash(typedData apitypes.TypedData) error {
...
func (e *OkamiSECP256K1) connectToLedgerApp() (sdkledger.SECP256K1, error) {
