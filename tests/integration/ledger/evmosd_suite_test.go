...
import (
	...
	"github.com/okamiblock/okamiblock/tests/integration/ledger/mocks"
	...
	clientkeys "github.com/okamiblock/okamiblock/client/keys"
	okamikeyring "github.com/okamiblock/okamiblock/crypto/keyring"
...
func (suite *LedgerTestSuite) SetupOkamiApp() {
...
func (suite *LedgerTestSuite) okamiAddKeyCmd() *cobra.Command {
...
func (suite *LedgerTestSuite) MockKeyringOption() keyring.Option {
	return func(options *keyring.Options) {
		options.SupportedAlgos = okamikeyring.SupportedAlgorithms
		options.SupportedAlgosLedger = okamikeyring.SupportedAlgorithmsLedger
		options.LedgerDerivation = func() (cosmosledger.SECP256K1, error) { return suite.ledger, nil }
		options.LedgerCreateKey = okamikeyring.CreatePubkey
		options.LedgerAppName = okamikeyring.AppName
		options.LedgerSigSkipDERConv = okamikeyring.SkipDERConversion
	}
}
