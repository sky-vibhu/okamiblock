...
// TestOkamiVersionsLess tests the OkamiVersions type's Less method with
// different version strings
func TestOkamiVersionsLess(t *testing.T) {
	var version OkamiVersions
...
// TestOkamiVersionsSwap tests the OkamiVersions type's Swap method
func TestOkamiVersionsSwap(t *testing.T) {
	var version OkamiVersions
	value := "v9.1.0"
...
// TestOkamiVersionsLen tests the OkamiVersions type's Len method
func TestOkamiVersionsLen(t *testing.T) {
	var version OkamiVersions = []string{"v9.1.0", "v10.0.0"}
