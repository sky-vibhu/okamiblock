...
// TestUpgrade tests if an Okami node can be upgraded from one version to another.
...
// TestCLITxs executes different types of transactions against an Okami node
