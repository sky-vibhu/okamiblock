...
def test_send_funds_to_distr_mod(okami_cluster):
    """
...
def test_send_funds_to_distr_mod_eth_tx(okami_cluster):
    """
    This tests the transfer of funds to the distribution module account,
    via ethereum tx
    which should be forbidden, since this is a blocked address.
...
def test_authz_nested_msg(okami_cluster):
    """
...
def test_create_invalid_vesting_acc(okami_cluster):
    """
    ...
    tx = cli.create_vesting_acc(
        ...
        "okami1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqzqpgshrm7",
    )
    try:
...
def test_vesting_acc_schedule(okami_cluster):
    """
    ...
    test_cases = [
        {
            ...
            "exp_err": "invalid decimal coin expression: -10000000000aOKM",
            "lockup": {
                "start_time": 1625204910,
                "periods": [
                    {
                        "length_seconds": 2419200,
                        "coins": "10000000000aOKM",
                    }
                ],
            },
            "vesting": {
...
def test_unvested_token_delegation(okami_cluster):
    """
                ...
                "periods": [
                    {
                        ...
                        "coins": "10000000000000000000aOKM",
                    }
                ],
            },
            lockup_file,
    ...
    del_amt = "7000000000000000000aOKM"
