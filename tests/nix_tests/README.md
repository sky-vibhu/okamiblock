...
different Okami and [Geth](https://github.com/ethereum/go-ethereum) clients with multiple configurations.
...
If you're changing anything on the okami rpc, rerun the first command.
