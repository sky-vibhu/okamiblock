...
def test_block(okami_cluster, geth):
    # Perform block queries (eth_getBlockByNumber & eth_getBlockByHash)
    # on okami and geth nodes, and compare the responses
    # Case 1: block without transactions
    get_blocks(okami_cluster, geth, False)
    # Case 2: block with transactions
    get_blocks(okami_cluster, geth, True)


def get_blocks(okami_rpc_ws, geth, with_transactions):
    w3: Web3 = okami_rpc_ws.w3
    eth_rpc = w3.provider
    ...
    okami_blk = w3.eth.get_block(1)
    # Get existing block, no transactions
    eth_rsp = eth_rpc.make_request(
        "eth_getBlockByHash", [okami_blk["hash"].hex(), with_transactions]
    )
...
def test_accounts(okami_cluster, geth):
    w3: Web3 = okami_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(eth_rpc, geth_rpc, "eth_accounts", [])


def test_syncing(okami_cluster, geth):
    w3: Web3 = okami_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_coinbase(okami_cluster, geth):
    w3: Web3 = okami_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_max_priority_fee(okami_cluster, geth):
    w3: Web3 = okami_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_gas_price(okami_cluster, geth):
    w3: Web3 = okami_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_block_number(okami_cluster, geth):
    w3: Web3 = okami_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_balance(okami_cluster, geth):
    w3: Web3 = okami_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_storage_at(okami_cluster, geth):
    w3: Web3 = okami_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_proof(okami_cluster, geth):
    # on okami the proof query will fail for block numbers <= 2
...
def test_get_code(okami_cluster, geth):
    w3: Web3 = okami_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_block_transaction_count(okami_cluster, geth):
    w3: Web3 = okami_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction(okami_cluster, geth):
    w3: Web3 = okami_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction_receipt(okami_cluster, geth):
    w3: Web3 = okami_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_fee_history(okami_cluster, geth):
    w3: Web3 = okami_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_estimate_gas(okami_cluster, geth):
...
def test_incomplete_send_transaction(okami_cluster, geth):
