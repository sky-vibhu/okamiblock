...
import (
	...
	"github.com/okamiblock/okamiblock/cmd/config"
...
var feePayerAddress = "okami17xpfvakm2amg962yls6f84z3kell8c5ljcjw34"
...
func createPopulatedTestCase(t *testing.T) TestCaseStruct {
	...
	msgSend := banktypes.MsgSend{
		...
		ToAddress:   "okami12luku6uxehhak02py4rcz65zu0swh7wjun6msa",
		Amount: sdk.NewCoins(
			sdk.NewCoin(
				utils.BaseDenom,
