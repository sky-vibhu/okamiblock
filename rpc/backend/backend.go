...
type EVMBackend interface {
	...
	GetTxByEthHash(txHash common.Hash) (*okamitypes.TxResult, error)
	GetTxByTxIndex(height int64, txIndex uint) (*okamitypes.TxResult, error)
...
type Backend struct {
	...
	indexer             okamitypes.EVMTxIndexer
}
...
func NewBackend(
	...
	chainID, err := okamitypes.ParseChainID(clientCtx.ChainID)
	if err != nil {
		panic(err)
	}
