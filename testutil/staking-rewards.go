...
func PrepareAccountsForDelegationRewards(t *testing.T, ctx sdk.Context, app *app.Okami, addr sdk.AccAddress, balance sdkmath.Int, rewards ...sdkmath.Int) (sdk.Context, error) {
