...
// createOkamiApp creates an okami app
func createOkamiApp(chainID string) *app.Okami {
	// Create okami app
	db := dbm.NewMemDB()
...
func setStakingGenesisState(okamiapp *app.Okami, genesisState simapp.GenesisState, overwriteParams StakingCustomGenesisState) simapp.GenesisState {
	// Set staking params
	...
	genesisState[stakingtypes.ModuleName] = okamiapp.AppCodec().MustMarshalJSON(stakingGenesis)
	return genesisState
}

// setAuthGenesisState sets the auth genesis state
func setAuthGenesisState(okamiapp *app.Okami, genesisState simapp.GenesisState, genAccounts []authtypes.GenesisAccount) simapp.GenesisState {
	authGenesis := authtypes.NewGenesisState(authtypes.DefaultParams(), genAccounts)
	genesisState[authtypes.ModuleName] = okamiapp.AppCodec().MustMarshalJSON(authGenesis)
	return genesisState
}
...
func setBankGenesisState(okamiapp *app.Okami, genesisState simapp.GenesisState, overwriteParams BankCustomGenesisState) simapp.GenesisState {
	...
	genesisState[banktypes.ModuleName] = okamiapp.AppCodec().MustMarshalJSON(bankGenesis)
	return genesisState
}
