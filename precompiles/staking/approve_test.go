...
func (s *PrecompileTestSuite) TestApprove() {
	...
	testCases := []struct {
		...
		{
			"success - MsgDelegate with 1 Okami as limit amount",
			func(_ *vm.Contract) []interface{} {
				return []interface{}{
					s.address,
					big.NewInt(1e18),
		...
		},
		{
			...
			func(_ *vm.Contract) []interface{} {
				...
				var err error
				s.ctx, err = okamiutil.Commit(s.ctx, s.app, time.Second, nil)
				...
				s.ctx, err = okamiutil.Commit(s.ctx, s.app, time.Hour*24*365, nil)
				s.Require().NoError(err, "failed to commit block")
		...
		{
			"success - MsgUndelegate with 1 Okami as limit amount",
			func(_ *vm.Contract) []interface{} {
				return []interface{}{
					s.address,
					big.NewInt(1e18),
		...
		{
			"success - MsgRedelegate with 1 Okami as limit amount",
			func(_ *vm.Contract) []interface{} {
				return []interface{}{
					s.address,
					big.NewInt(1e18),
		...
		{
			"success - MsgRedelegate, MsgUndelegate and MsgDelegate with 1 Okami as limit amount",
			func(_ *vm.Contract) []interface{} {
				return []interface{}{
					s.address,
					big.NewInt(1e18),
...
func (s *PrecompileTestSuite) TestDecreaseAllowance() {
	...
	testCases := []struct {
		...
		{
			"success - decrease delegate authorization allowance by 1 Okami",
			func(_ *vm.Contract) []interface{} {
...
func (s *PrecompileTestSuite) TestIncreaseAllowance() {
	...
	testCases := []struct {
		...
		{
			"success - increase delegate authorization allowance by 1 Okami",
			func() []interface{} {
...
func (s *PrecompileTestSuite) TestRevoke() {
	...
	granteeAddr := okamiutiltx.GenerateAddress()
