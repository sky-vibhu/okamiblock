...
func (s *PrecompileTestSuite) TestIncreaseAllowanceEvent() {
	...
	testCases := []struct {
		...
		{
			"success - increased allowance for all 3 methods by 1 okami",
			func() []interface{} {
				return []interface{}{
					s.address,
...
func (s *PrecompileTestSuite) TestDecreaseAllowanceEvent() {
	...
	testCases := []struct {
		...
		{
			"success - decreased allowance for all 3 methods by 1 okami",
			func() []interface{} {
				return []interface{}{
					s.address,
					big.NewInt(1000000000000000000),
