...
func Call(ctx sdk.Context, app *okamiapp.Okami, args CallArgs) (res abci.ResponseDeliverTx, ethRes *evmtypes.MsgEthereumTxResponse, err error) {
	var (
		nonce    uint64
	...
	res, err = okamiutil.DeliverEthTx(app, args.PrivKey, msg)
	if err != nil {
...
func CallContractAndCheckLogs(ctx sdk.Context, app *okamiapp.Okami, cArgs CallArgs, logCheckArgs testutil.LogCheckArgs) (abci.ResponseDeliverTx, *evmtypes.MsgEthereumTxResponse, error) {
