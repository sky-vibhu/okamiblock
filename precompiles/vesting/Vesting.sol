...
string constant MSG_CREATE_CLAWBACK_VESTING_ACCOUNT = "/okami.vesting.v2.MsgCreateClawbackVestingAccount";
string constant MSG_FUND_VESTING_ACCOUNT = "/okami.vesting.v2.MsgFundVestingAccount";
string constant MSG_CLAWBACK = "/okami.vesting.v2.MsgClawback";
string constant MSG_CONVERT_VESTING_ACCOUNT = "/okami.vesting.v2.MsgConvertVestingAccount";
string constant MSG_UPDATE_VESTING_FUNDER = "/okami.vesting.v2.MsgUpdateVestingFunder";
