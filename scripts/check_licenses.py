...
There are the following license types that are used in the project:
    - ENCL: This license is used for all files containing Okami IP.
...
EXEMPT_FILES: List[str] = [
    ...
    r"proto/okami/revenue/v1/",  # All files in this folder
    r"proto/okami/claims/v1/genesis\.proto$",
]
...
ENCL_LICENSE = [
    "// Copyright Tharsis Labs Ltd.(Okami)\n",
    "// SPDX-License-Identifier:ENCL-1.0(https://github.com/okami/okami/blob/main/LICENSE)\n"
]
