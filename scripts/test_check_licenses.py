...
def test_check_if_in_exempt_files_not_included():
    file = "/Users/malte/dev/go/okami/okami/app/app.go"
    assert cl.check_if_in_exempt_files(file) is False


def test_check_if_in_exempt_files_included():
    file = "/Users/malte/dev/go/okami/okami/x/revenue/v1/genesis.go"
    assert cl.check_if_in_exempt_files(file) is True

    file = "/Users/malte/dev/go/okami/okami/x/claims/genesis.go"
    assert cl.check_if_in_exempt_files(file) is True

    file = "/Users/malte/dev/go/okami/okami/x/erc20/keeper/proposals.go"
    assert cl.check_if_in_exempt_files(file) is True

    file = "/Users/malte/dev/go/okami/okami/x/erc20/types/utils.go"
    assert cl.check_if_in_exempt_files(file) is True

    file = "/Users/malte/dev/go/okami/okami/x/evm/genesis.go"
    assert cl.check_if_in_exempt_files(file) is False
