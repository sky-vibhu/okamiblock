...
# Initialize chain.
okamid init test --chain-id okami_9000-2

# Get Genesis
wget https://archive.okami.org/mainnet/genesis.json
mv genesis.json ~/.okamid/config/

wget -O ~/.okamid/config/adrbook.json https://snapshot.notional.ventures/okami/addrbook.json
...
export OKAMID_P2P_MAX_NUM_INBOUND_PEERS=200
export OKAMID_P2P_MAX_NUM_OUTBOUND_PEERS=200
export OKAMID_STATESYNC_RPC_SERVERS="https://okami-rpc.polkachu.com:443,https://rpc-okami-ia.notional.ventures:443"
