...
Okami Non-Commercial License 1.0 (ENCL-1.0) was created by Tharsis Labs Ltd.
(Okami) to provide a mutually beneficial balance between the user benefits of
...
**Q: What is Okami Non-Commercial License 1.0 (ENCL-1.0)?**
...
blockchain consensus.The initial Designated Blockchains shall be the Okami
blockchains, identified by chain identifiers 9000 (testing network or testnet)
and 9001 (main network or mainnet).

Apart from Okami repository, Okami is currently building the Okami Software
Development Kit (Okami SDK), to help developers to create their own
EVM-compatible blockchain network with custom parameters. Once it is publicly
available, you may use the Okami SDK instead for your commercial project,
subject to the applicable Okami SDK license. For more information about Okami
SDK, check out the Okami Manifesto.
...
open source, such as empowering all non-Okami software developers to be part of
...
**Q: What if I am currently using Okami code commercially in my business/project?**

**A:**You are allowed to continue using the code from older versions (<v13.0.0)
of Okami repository under LGPL 3.0, however, you must obtain a commercial permit
...
"Required Notice: Copyright Tharsis Labs Ltd. (Okami)(https://github.com/okami)"
...
Okami does not claim it to be one. The legal phrasing of the ENCL 1.0 has been
...
**A:** Okami stays the maintainer of the Ethermint repository, which will remain
under the LGPL v3 license. New features developments that have been previously
planned to be included on Ethermint are instead going to be part of Okami SDK.
For more information on the Okami SDK, check out the Okami Manifesto.
...
permit from Okami for the ENCL code, but we will not grant rights to release the
...
**A:** First, a big thank you! You can contribute the code to the official Okami
