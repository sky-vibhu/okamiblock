...
import (
	...
	rpctypes "github.com/okamiblock/okamiblock/rpc/types"
...
var _ okamitypes.EVMTxIndexer = &KVIndexer{}
...
func (kv *KVIndexer) GetByTxHash(hash common.Hash) (*okamitypes.TxResult, error) {
...
func (kv *KVIndexer) GetByBlockAndIndex(blockNumber int64, txIndex int32) (*okamitypes.TxResult, error) {
...
func saveTxResult(codec codec.Codec, batch dbm.Batch, txHash common.Hash, txResult *okamitypes.TxResult) error {
