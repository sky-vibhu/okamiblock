...
// source: okami/epochs/v1/genesis.proto
...
func init() {
	proto.RegisterType((*EpochInfo)(nil), "okami.epochs.v1.EpochInfo")
	proto.RegisterType((*GenesisState)(nil), "okami.epochs.v1.GenesisState")
}

func init() { proto.RegisterFile("okami/epochs/v1/genesis.proto", fileDescriptor_c74bc0b3e7fa01c2) }
