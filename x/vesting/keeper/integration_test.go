...
import (
	...
	"github.com/okamiblock/okamiblock/x/vesting/types"
)
...
//
// Example:
// 21/10 Employee joins Okami and vesting starts
		...
		BeforeEach(func() {
			...
			msgSubmitProposal, err := govv1beta1.NewMsgSubmitProposal(
				&erc20types.RegisterERC20Proposal{
					...
					Description:    "this is an example of a governance proposal to upgrade the okami app",
