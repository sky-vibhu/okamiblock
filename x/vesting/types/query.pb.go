...
// source: okami/vesting/v2/query.proto
...
func init() {
	proto.RegisterType((*QueryBalancesRequest)(nil), "okami.vesting.v2.QueryBalancesRequest")
	proto.RegisterType((*QueryBalancesResponse)(nil), "okami.vesting.v2.QueryBalancesResponse")
}

func init() { proto.RegisterFile("okami/vesting/v2/query.proto", fileDescriptor_e31744b0ce27e85a) }
...
func (c *queryClient) Balances(ctx context.Context, in *QueryBalancesRequest, opts ...grpc.CallOption) (*QueryBalancesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/okami.vesting.v2.Query/Balances", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Balances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/okami.vesting.v2.Query/Balances",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "okami.vesting.v2.Query",
	...
	Metadata: "okami/vesting/v2/query.proto",
}
