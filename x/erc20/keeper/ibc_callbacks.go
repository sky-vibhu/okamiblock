...
import (
	...
	"github.com/okamiblock/okamiblock/ibc"
...
// registered via governance. Note that the native staking denomination (e.g. "aOKM"),
...
func (k Keeper) OnRecvPacket(
	...
	// Get addresses in `okami1` and the original bech32 format
...
func (k Keeper) ConvertCoinToERC20FromPacket(ctx sdk.Context, data transfertypes.FungibleTokenPacketData) error {
	...
	// assume that all module accounts on Okami need to have their tokens in the
