// Copyright 2022 Okami Foundation
// This file is part of the Okami Network packages.
//
// Okami is free software: you can redistribute it and/or modify
// it under the terms of the GNU Lesser General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// The Okami packages are distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU Lesser General Public License for more details.
//
// You should have received a copy of the GNU Lesser General Public License
// along with the Okami packages. If not, see https://github.com/okami/okami/blob/main/LICENSE
package v5_test
...
import (
	...
	v5 "github.com/okamiblock/okamiblock/x/evm/migrations/v5"
	v5types "github.com/okamiblock/okamiblock/x/evm/migrations/v5/types"
	"github.com/okamiblock/okamiblock/x/evm/types"
)
