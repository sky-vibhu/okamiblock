...
var (
	pattern_Msg_EthereumTx_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"okami", "evm", "v1", "ethereum_tx"}, "", runtime.AssumeColonVerbOpt(false)))
)
