...
// RANDAO implementation. See https://github.com/okami/ethermint/pull/1520#pullrequestreview-1200504697
...
func (k *Keeper) NewEVM(
	...
	blockCtx := vm.BlockContext{
		...
		GasLimit:    okamitypes.BlockGasLimit(ctx),
...
func (k Keeper) GetHashFn(ctx sdk.Context) vm.GetHashFunc {
	return func(height uint64) common.Hash {
		h, err := okamitypes.SafeInt64(height)
		if err != nil {
...
func (k *Keeper) ApplyMessageWithConfig(ctx sdk.Context,
	...
	// for more info https://github.com/okami/ethermint/issues/1085
