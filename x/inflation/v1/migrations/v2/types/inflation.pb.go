...
// The initial V2InflationDistribution can be calculated from the Okami Token
// Model like this:
...
func init() {
	proto.RegisterType((*V2InflationDistribution)(nil), "okami.inflation.v1.V2InflationDistribution")
	proto.RegisterType((*V2ExponentialCalculation)(nil), "okami.inflation.v1.V2ExponentialCalculation")
}
