...
var pattern_Msg_UpdateParams_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"okami", "inflation", "v1", "tx", "update_params"}, "", runtime.AssumeColonVerbOpt(false)))
