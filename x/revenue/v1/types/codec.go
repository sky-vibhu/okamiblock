...
const (
	// Amino names
	cancelRevenueName   = "okami/MsgCancelRevenue"
	registerRevenueName = "okami/MsgRegisterRevenue"
	updateRevenueName   = "okami/MsgUpdateRevenue"
	updateParamsName    = "okami/MsgUpdateParams"
)
