// Copyright Tharsis Labs Ltd.(Okami)
...
import (
	...
	"github.com/okamiblock/okamiblock/x/revenue/v1/types"
)
...
func (k Keeper) Revenue(
	...
	if err := okamitypes.ValidateNonZeroAddress(req.ContractAddress); err != nil {
...
func (k Keeper) DeployerRevenues( //nolint: dupl
	...
	if err != nil {
		return nil, status.Errorf(
			codes.InvalidArgument,
			"invalid format for deployer %s, should be bech32 ('okami...')", req.DeployerAddress,
		)
	}
...
func (k Keeper) WithdrawerRevenues( //nolint: dupl
	...
	if err != nil {
		return nil, status.Errorf(
			codes.InvalidArgument,
			"invalid format for withdraw addr %s, should be bech32 ('okami...')", req.WithdrawerAddress,
		)
	}
